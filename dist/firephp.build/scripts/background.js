...
},{"./platform/node/binary":11,"./util":14}],7:[function(require,module,exports){
...
},{"./platform/browser/http-client":10,"./uri":13}],8:[function(require,module,exports){
...
},{"./struct":12,"./util":14}],10:[function(require,module,exports){
...
},{"./binary":6,"./util":14}],13:[function(require,module,exports){
...
},{"./channel":18}],16:[function(require,module,exports){
...
},{"./channel":18,"fp-modules-for-nodejs/lib/util":14}],17:[function(require,module,exports){
...
},{"./channel":18}],18:[function(require,module,exports){
...
},{"./protocol":22,"./transport":25,"fp-modules-for-nodejs/lib/util":14}],19:[function(require,module,exports){
...
},{"../channel":18,"fp-modules-for-nodejs/lib/http-client":7,"fp-modules-for-nodejs/lib/json":8,"fp-modules-for-nodejs/lib/util":14}],20:[function(require,module,exports){
...
},{"./message":21,"fp-modules-for-nodejs/lib/json":8,"fp-modules-for-nodejs/lib/util":14}],23:[function(require,module,exports){
...
},{"../wildfire":26,"fp-modules-for-nodejs/lib/json":8}],25:[function(require,module,exports){
...
},{"./message":21,"./receiver":23,"./wildfire":26,"fp-modules-for-nodejs/lib/json":8,"fp-modules-for-nodejs/lib/md5":9,"fp-modules-for-nodejs/lib/struct":12}],26:[function(require,module,exports){
...
},{"./channel-httpheader":15,"./channel-postmessage":16,"./channel-shellcommand":17,"./channel/http-client":19,"./dispatcher":20,"./message":21,"./receiver":23,"./stream/callback":24}],27:[function(require,module,exports){
"use strict";
...
exports.for = function (API) {
    ...
    return {
        register: function register(_processor) {
...
function broadcastForContext(context, message) {
    if (context) {
        ...
        if (typeof context.windowId === "undefined" && typeof context.frameId !== "undefined" && typeof windowIdByFrameId["" + context.frameId] !== "undefined") {
...
},{"./wildfire":33}],30:[function(require,module,exports){
"use strict";
...
BROWSER.storage.onChanged.addListener(function (changes, area) {
    ...
    try {
        for (var _iterator = Object.keys(changes)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
exports.isEnabledForDomain = function (domain) {
    return exports.getDomainSettingsForDomain(domain).then(function (settings) {
        return settings.enabled && (settings.enableUserAgentHeader || settings.enableFirePHPHeader);
    });
};
...
httpHeaderChannel.addListener({
    afterChannelOpen: function afterChannelOpen(context) {
...
},{"./adapters/http-request-observer":27,"./adapters/http-response-observer":28,"./receivers/firephp":30,"./receivers/insight":31,"./settings":32,"eventemitter2":5,"wildfire-for-js":26}]},{},[29])(29)
});
	});
});