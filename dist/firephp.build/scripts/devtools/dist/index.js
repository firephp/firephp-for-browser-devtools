...
var Codeblock = exports.Codeblock = function (code, format, args) {
  if (typeof code === "object" && code.hasOwnProperty("raw") && Object.keys(code).length === 1) {
    this._code = code.raw;
  } else {
    if (code) {
      this.setCode(code);
...
},{"./jsonrep":3}],3:[function(require,module,exports){
"use strict";
...
},{"codeblock/codeblock.rt0":1,"pinf-loader-js":4}],4:[function(require,module,exports){
"use strict";
