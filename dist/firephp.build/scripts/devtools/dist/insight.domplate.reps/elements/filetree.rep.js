...
function impl(domplate) {
  ...
  return {
    ...
    onClick: function onClick(event) {
      ...
      var nameTag = domplate.util.getAncestorByClass(event.target, "name");
      ...
      var masterRect = {
        "left": nameTag.getBoundingClientRect().left,
        "top": nameTag.getBoundingClientRect().top,
        "right": nameTag.getBoundingClientRect().left + 20,
        "bottom": nameTag.getBoundingClientRect().bottom
      };
      console.log("pointer", pointer);
      console.log("masterRect", masterRect);
    ...
    onSelect: function onSelect(event) {
      ...
      memberTag.contextObject.dispatchEvent('click', [event, {
        "rep": "insight.domplate.reps/elements/filetree",
...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","abbeebffe77c4443814b689a73623f6e9463b059", "\"", " __dtid=\"","insight.domplate.reps/elements/filetree", "\"", " class=\"","dictionary", " ", "\"",">","<span",">","(","</span>","<span", " class=\"","collapsed", " ", "\"",">",__escape__(getMemberCount(node)),"</span>","<span",">",")","</span>","</span>");  }}})
}
,
"expandableStub":function (context) {
var DomplateDebug = context.DomplateDebug;
...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","abbeebffe77c4443814b689a73623f6e9463b059", "\"", " __dtid=\"","insight.domplate.reps/elements/filetree", "\"", " class=\"","more", " ", "\"",">"," ... ","</span>");  }}})
}
};
  rep.__dbid = "abbeebffe77c4443814b689a73623f6e9463b059";
  rep.__dtid = "insight.domplate.reps/elements/filetree";
  ...
  rep.__ensureCssInjected = function () {
    ...
    injectedCss = true;
    domplate.loadStyle("elements/filetree.rep.css", options.cssBaseUrl || undefined);
  };
