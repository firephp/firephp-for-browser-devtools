...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","e7edf46c5cf053a32cad8a256bef09bba0a1db61", "\"", " __dtid=\"","php/array-indexed", "\"", " class=\"","array", " ", "\"",">","<span",">",__escape__(VAR_label),"(","</span>","<span", " class=\"","collapsed", " ", "\"",">","... ",__escape__(getElementCount(node))," ...","</span>","<span",">",")","</span>","</span>");  }}})
}
,
"shortTag":function (context) {
var DomplateDebug = context.DomplateDebug;
...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","e7edf46c5cf053a32cad8a256bef09bba0a1db61", "\"", " __dtid=\"","php/array-indexed", "\"",">"," ... ","</span>");  }}})
}
};
  rep.__dbid = "e7edf46c5cf053a32cad8a256bef09bba0a1db61";
  rep.__dtid = "php/array-indexed";
  ...
  rep.__ensureCssInjected = function () {
    ...
    injectedCss = true;
    domplate.loadStyle("php/array-indexed.rep.css", options.cssBaseUrl || undefined);
  };
