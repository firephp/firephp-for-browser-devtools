...
function impl(domplate) {
  ...
  return {
    ...
    isExpandable: function isExpandable(node) {
      return true;
      return node.type == "reference" || node.type == "filetree" || node.type == "map" || node.type == "array";
    },
...
return (function (root, context, o, d0) {  var l0 = 0;  var if_0 = 0;  var e0 = 0;  with (this) {      l0 = __loop__.apply(this, [d0, function(i0,l0,d0,d1,d2,d3,d4,d5) {        node = __path__(root, o,0+l0+0);node.addEventListener("click", __bind__(this, d0), false);node.memberObject = d1;node.contextObject = d2;        node = __path__(root, o,0+l0+0,0+1+1,0);        e0 = __link__(node, d3, d4);      if_0 = __if__.apply(this, [d5, function(if_0) {      }]);        return 0+1;      }]);  }  return 1;})
}
,
...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","77a4ea3f2f877bdbce48a9c8f3bb26e983097a74", "\"", " __dtid=\"","elements/optiontree", "\"", " class=\"","dictionary", " ", "\"",">","<span",">",__escape__(getLabel(node)),"(","</span>","<span", " class=\"","collapsed", " ", "\"",">","... ",__escape__(getMemberCount(node))," ...","</span>","<span",">",")","</span>","</span>");  }}})
}
,
"expandableStub":function (context) {
var DomplateDebug = context.DomplateDebug;
...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","77a4ea3f2f877bdbce48a9c8f3bb26e983097a74", "\"", " __dtid=\"","elements/optiontree", "\"", " class=\"","more", " ", "\"",">"," ... ","</span>");  }}})
}
};
  rep.__dbid = "77a4ea3f2f877bdbce48a9c8f3bb26e983097a74";
  rep.__dtid = "elements/optiontree";
  ...
  rep.__ensureCssInjected = function () {
    ...
    injectedCss = true;
    domplate.loadStyle("elements/optiontree.rep.css", options.cssBaseUrl || undefined);
  };
