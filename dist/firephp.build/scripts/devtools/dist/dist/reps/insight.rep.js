...
exports.operator = function (name, length, block) {
  var operator = function operator() {
    ...
    var completion = function completion(object) {
      if (_typeof(object) == "object" && object !== null && name in object && !Object.prototype.hasOwnProperty.call(object, name)) return object[name].apply(object, args);
...
exports.copy = exports.operator('copy', 1, function (object) {
  ...
  if (_typeof(object) == 'object') return exports.object.copy(object);
  return object;
});
exports.deepCopy = exports.operator('deepCopy', 1, function (object) {
  ...
  if (_typeof(object) == 'object') return exports.object.deepCopy(object);
  return object;
});
exports.repr = exports.operator('repr', 1, function (object) {
  ...
  if (_typeof(object) == 'object' && !(object instanceof Date)) return exports.object.repr(object);
  if (typeof object == 'string') return exports.enquote(object);
  return object.toString();
});
exports.keys = exports.operator('keys', 1, function (object) {
  if (exports.isArrayLike(object)) return exports.range(object.length);else if (_typeof(object) == 'object') return exports.object.keys(object);
  return [];
});
exports.values = exports.operator('values', 1, function (object) {
  if (exports.isArrayLike(object)) return exports.array(object);else if (_typeof(object) == 'object') return exports.object.values(object);
  return [];
});
exports.items = exports.operator('items', 1, function (object) {
  if (exports.isArrayLike(object) || typeof object == "string") return exports.enumerate(object);else if (_typeof(object) == 'object') return exports.object.items(object);
  return [];
});
exports.len = exports.operator('len', 1, function (object) {
  if (exports.isArrayLike(object)) return exports.array.len(object);else if (_typeof(object) == 'object') return exports.object.len(object);
});
exports.has = exports.operator('has', 2, function (object, value) {
  if (exports.isArrayLike(object)) return exports.array.has(object, value);else if (_typeof(object) == 'object') return exports.object.has(object, value);
  return false;
});
exports.get = exports.operator('get', 2, function (object, key, value) {
  if (typeof object == "string") {
    if (!_typeof(key) == "number") throw new Error("TypeError: String keys must be numbers");
...
exports.eq = exports.operator('eq', 2, function (a, b, stack) {
  ...
  if (_typeof(a) === 'object') return exports.object.eq(a, b, stack.concat([a.constructor]));
  return false;
});
...
},{"../encoder/default":5,"fp-modules-for-nodejs/lib/json":2,"fp-modules-for-nodejs/lib/util":3}],5:[function(require,module,exports){
"use strict";
...
},{"fp-modules-for-nodejs/lib/json":2,"fp-modules-for-nodejs/lib/util":3}],6:[function(require,module,exports){
"use strict";
...
},{"insight-for-js/lib/decoder/default":4,"insight-for-js/lib/encoder/default":5,"insight.domplate.reps":6}]},{},[7])(7)
});
