      ...
      return {
        ...
        "on": {
          "mount": function mount(el) {
            ...
            riot.tag2('tag_79ead959acf10ddc1e7294d654982b8f98c9ff40', '<div class="menu"> <button onclick="{triggerRelooad}">Reload</button> <button onclick="{triggerClear}">Clear</button> <input type="checkbox" name="settings.persist-on-navigate" onchange="{notifyPersistChange}">Persist <button onclick="{triggerManage}">Manage</button> </div>', '', '', function (opts) {
              var tag = this;
            ...
            riot.mount(el, 'tag_79ead959acf10ddc1e7294d654982b8f98c9ff40', context);
          }
        }
      };
    }
