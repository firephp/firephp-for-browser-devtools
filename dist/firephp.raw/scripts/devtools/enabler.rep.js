            ...
            return {
                ...
                "on": {
                    "mount": function mount(el) {
                        ...
                        riot.tag2('tag_baa65ed88ea3d4aeae4866595d27431812d73ea6', '<div> <button if="{!enabled}" onclick="{triggerEnable}" class="enable">Enable</button> <button if="{enabled}" onclick="{triggerDisable}" class="disable">Disable</button> </div>', 'tag_baa65ed88ea3d4aeae4866595d27431812d73ea6 BUTTON,[data-is="tag_baa65ed88ea3d4aeae4866595d27431812d73ea6"] BUTTON{ width: 100%; height: 20px; border: 2px; font-weight: bold; cursor: pointer; background-color: white; padding: 3px; height: auto; } tag_baa65ed88ea3d4aeae4866595d27431812d73ea6 BUTTON.enable,[data-is="tag_baa65ed88ea3d4aeae4866595d27431812d73ea6"] BUTTON.enable{ color: #007200; border-top: 2px solid #ff5151; border-bottom: 2px solid #ff5151; border-left: 10px solid #ff5151; border-right: 10px solid #ff5151; } tag_baa65ed88ea3d4aeae4866595d27431812d73ea6 BUTTON.disable,[data-is="tag_baa65ed88ea3d4aeae4866595d27431812d73ea6"] BUTTON.disable{ color: #900; border-top: 2px solid #05c600; border-bottom: 2px solid #05c600; border-left: 10px solid #05c600; border-right: 10px solid #05c600; }', '', function (opts) {
                            ...
                            if (typeof browser !== "undefined") {
                                var getSettingForHostname = function getSettingForHostname(hostname, name) {
                                ...
                                var setSettingForHostname = function setSettingForHostname(hostname, name, value) {
                                    var obj = {};
                        ...
                        riot.mount(el, 'tag_baa65ed88ea3d4aeae4866595d27431812d73ea6', context);
                    }
                }
            };
        }
